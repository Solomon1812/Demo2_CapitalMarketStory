    ...
    public partial class MLCapitalModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"I1", @"I1"),new InputOutputColumnPair(@"I2", @"I2"),new InputOutputColumnPair(@"I7", @"I7"),new InputOutputColumnPair(@"I13", @"I13"),new InputOutputColumnPair(@"I18", @"I18"),new InputOutputColumnPair(@"I20", @"I20")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=864,NumberOfIterations=4,MinimumExampleCountPerLeaf=22,LearningRate=0.43817877171947006,LabelColumnName=@"I10",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.978944457388246,L1Regularization=2E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=264}));
